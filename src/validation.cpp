...
#if defined(NDEBUG)
# error "pocketchain cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "pocketchain Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PKC additional fees, %d delta bytes\n",
