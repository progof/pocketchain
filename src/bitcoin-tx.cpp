...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pocketchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pocketchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pocketchain transaction") + "\n" +
              "  pocketchain-tx [options] -create [commands]   " + _("Create hex-encoded pocketchain transaction") + "\n" +
              "\n";
