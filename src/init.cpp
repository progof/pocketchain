...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pocketchain-project/pocketchain>";
    const std::string URL_WEBSITE = "<https://www.pocketchain.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("pocketchain version %s\n", FormatFullVersion());
}
